...
OOP Topic's:
	// 1.Creating Class and Object: [1-creatingClassAndObject.php]
        => Opp's-concepts/1.0-Oop's-Basic.php
        => oop2018/1_Classes_Objects.php

	// 2.Constructor and Destructor: [2-constructorAndDestructor.php]
        => Opp's-concepts/1.3-Oop's-Constructor-Destructor.php
        => oop2018/5_Constructors_Destructors.php

	// 3.Inheritance: [3-inheritance.php]
        => Opp's-concepts/1.4-Oop's-Extends.php
        => oop2018/6_Object_Inheritance.php

	// 4.Access Specified (Public, Private, Protected): [4-accessSpecified.php]
	...
	11.Traits: [11-traits.php]
        => Opp's-concepts/1.8-Oop's-Traits.php
        => oop2018/11_Traits.php

	12.Magic Methods: [12-magicMethods.php]
        => Opp's-concepts/3-Magic_method-Main.php
        => oop2018/14_Magic_Methods.php

	13.Object Cloning: [13-objectCloning.php]
        => Opp's-concepts/1.8-Oop's-Cloning.php
        => Opp's-concepts/1.8-Oop's-Object_Cloning.php

	14.Type Hinting/Type Declaration: [14-typeHinting.php]
        => Opp's-concepts/

	15.Autoload Class: [15-autoloadClass.php]
        => oop2018/Autoloading_Classes
        => oop2018/4_Autoloading_Classe.php

	16.Anonymous Classes In OOP: [16-anonymousClasses.php]
        => Opp's-concepts/

	17.Namespace: [17-namespace.php]
        => Opp's-concepts/
    ...
    => project-info/Opp's-concepts/bkp/oop2018/8_Polymorphism_Encapsulation.php
	...
	6.Constants: [constants.php] ~~~~~ Not Needed
        => Opp's-concepts/
        => oop2018/7_Scope_Resolution_Operator.php
